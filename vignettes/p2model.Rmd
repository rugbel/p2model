...
function, though the results in Bellio and Soriani (2017) suggests that first-order
...
basic way to call the function in this example would  simply  be `fit_p2_IS(fit, nc = detectCores())`.
